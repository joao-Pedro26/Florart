...
<footer class="rodape">
  <div class="rodape-container">
    <section id="sobre" class="ancora">
      <h3>Sobre a Florart</h3>
      <p>
        Somos uma empresa que acredita na força da natureza e no poder transformador da beleza.
        Valorizamos a mais bela forma de vida — as flores — que encantam, emocionam e trazem alegria
        a cada momento. Em cada pétala, enxergamos delicadeza; em cada cor, a expressão de sentimentos;
        e em cada arranjo, a chance de tornar a vida mais especial e inesquecível.
      </p>
    </section>
